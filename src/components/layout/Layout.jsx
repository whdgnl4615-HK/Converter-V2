...
export default function Layout() {
  ...
  return (
    <div className="flex min-h-screen" style={{background:'var(--bg)'}}>
      {/* Sidebar */}
      <aside className="w-56 flex-shrink-0 flex flex-col" style={{background:'var(--s1)',borderRight:'1px solid var(--border)',boxShadow:'2px 0 8px rgba(0,0,0,0.06)'}}>
        {/* Logo */}
        <div className="px-5 py-5 border-b" style={{borderColor:'var(--border)',background:'var(--s1)'}}>
