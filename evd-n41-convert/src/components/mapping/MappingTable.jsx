...
const TAG = {
  ...
  ai:       { label: 'AI',    style: {background:'rgba(124,106,247,0.15)',color:'var(--accent)'} },
}
            ...
            return (
              <div key={col} className="grid items-start px-4 py-2"
                style={{
                  ...
                  background: suggestion && !isApplied ? 'rgba(124,106,247,0.04)' : 'transparent',
                }}>
                  ...
                  {suggestion && !isApplied && (
                    <div className="mt-1.5 flex items-center gap-1.5">
                      <span className="text-xs mono px-1.5 py-0.5 rounded"
                        style={{background:'rgba(124,106,247,0.15)',color:'var(--accent)',border:'1px solid rgba(124,106,247,0.3)'}}>
                        ✨ AI: {suggestion}
                      </span>
