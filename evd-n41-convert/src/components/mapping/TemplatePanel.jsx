              ...
              <div key={tpl.id} className="rounded-lg p-3" style={{
                ...
                <div className="flex items-center justify-between mb-1">
                  <div className="flex items-center gap-2">
                    ...
                    {tpl.is_default && (
                      <span className="text-xs mono px-1.5 py-0.5 rounded" style={{background:'rgba(61,214,140,0.1)',color:'var(--green)'}}>
                ...
                <div className="flex gap-1.5 flex-wrap">
                  ...
                  {!tpl.is_default && (
                    <button onClick={() => onSetDefault(tpl.id)}
                      className="px-2 py-1 rounded text-xs mono transition-all"
                      style={{background:'rgba(61,214,140,0.08)',color:'var(--green)',border:'1px solid rgba(61,214,140,0.2)'}}>
